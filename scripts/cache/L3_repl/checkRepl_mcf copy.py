...
# read mcf_1752db
conn1 = sqlite3.connect('/nfs/home/zhangruisi/Downloads/xs-env/buildfile/2023-12-20@03:36:21.db')
...
# read mcf_23136db
conn3 = sqlite3.connect('/nfs/home/zhangruisi/Downloads/xs-env/buildfile/2023-12-20@08:02:40.db')
...
data1_new = np.array(data1_np[:, :3])
# data2_new = np.array(data2_np[:, :3])
# data3_new = np.array(data3_np[:, :3])

# data1_int = data1_new.astype(int)
# data2_int = data2_new.astype(int)
# data3_int = data3_new.astype(int)


# result1 = [tup for tup in data1_int if 38042527 <= tup[1] <= 38042600]
# result2 = [tup for tup in data2_int if 69669041 <= tup[1] <= 69669100]
# result3 = [tup for tup in data3_int if 68029464 <= tup[1] <= 68029500]

# if result1:
#     print("元组中第一个元素等于特定值的元组是：", result1[0])
# else:
#     print("没有找到符合条件的元组")

# if result2:
#     print("元组中第一个元素等于特定值的元组是：", result2[0])
# else:
#     print("没有找到符合条件的元组")

# if result3:
#     print("元组中第一个元素等于特定值的元组是：", result3[0])
# else:
#     print("没有找到符合条件的元组")
