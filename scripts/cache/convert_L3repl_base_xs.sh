...

{
  ...
  $8 = sprintf("hitWay=%d", hitWay); # hitVec
  $9 = sprintf("agevec=%d%d%d%d", age0, age1, age2, age3);
  $10 = sprintf("wayCnt0=%ld", wayCnt0)
  $11 = sprintf("wayCnt1=%ld", wayCnt1)
  $12 = sprintf("wayCnt2=%ld", wayCnt2)
  $13 = sprintf("wayCnt3=%ld", wayCnt3)
  $14 = sprintf("tripCount=%d", tripCount)
  $15 = sprintf("useCount=%d", useCount)           
  $16 = sprintf("sliceId=%d", bank)
  $17 = "";
  $18 = "";
  $19 = "";
  $20 = "";
